							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<!-- Register Form -->
<!-- Register Form -->
<form action="<?= site_url('/registerStudent') ?>" method="post">
	<div class="form-group form-focus">
        <input type="text" name="school_id" class="form-control floating" required>
        <label class="focus-label">School_ID</label>
    </div>
    <div class="form-group form-focus">
        <input type="text" name="first_name" class="form-control floating" required>
        <label class="focus-label">First Name</label>
    </div>
    <div class="form-group form-focus">
        <input type="text" name="last_name" class="form-control floating" required>
