    ...
    <body>
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavA  ccordion">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Price: ₱<?= $ticket_type['Price'] ?> (Quantity: <?= $ticket_type['Quantity'] ?>)</p>
                        <!-- Form for purchasing tickets -->
                        <form action="/purchase_tickets/<?= $ticket_type['TicketTypeID'] ?>" method="post">
